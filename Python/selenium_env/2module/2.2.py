...
# browser.execute_script("return arguments[0].scrollIntoView(true);", button) это значит проскроллить до момента, когда все нужные элементы будут видны на странице
# button.click()
